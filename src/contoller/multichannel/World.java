...
/**
 * Diese Klasse erstellt eine Umgebung für die Präsentation. Annas Computer (mit
 * Drucker), ihr Nokia und Charlies Black Berry.
 * 
 */
public class World {
    ...
    public World() {
        ...
        annasNokia.getMessageClient().setAccountFor(MessageType.SMS,
                annasSwisscomAbo);
        annasNokia.getMessageClient().setAccountFor(MessageType.MMS,
                annasSwisscomAbo);
        ...
        charliesSunriseAbo.setLoginCredentials(new IMEI(charliesBlackberry
                .getImei()));
        MessageClient charliesBBMessanger = charliesBlackberry
                .getMessageClient();
        ...
        generateMessages(20, charliesEmail, charliesBBMessanger,
                MessageType.EMAIL);
        generateMessages(30, charliesTelNr, charliesBBMessanger,
                MessageType.SMS);
        generateMessages(10, charliesTelNr, charliesBBMessanger,
                MessageType.MMS);
        generateMessages(50, annasEmail, annasComputer.openMailProgram(),
                MessageType.EMAIL);
        generateMessages(40, annasTelNr, annasNokia.getMessageClient(),
                MessageType.SMS);
        generateMessages(10, annasTelNr, annasNokia.getMessageClient(),
                MessageType.MMS);

        // Nachricht mit Anhang erstellen
        EmailMessage message2 = (EmailMessage) annasComputer.openMailProgram()
        ...
        Message message = annasComputer.openMailProgram().newMessage(
                MessageType.EMAIL);
