...
public class MainFrame extends JFrame {
     ...
     *            Der MessageType
     * @param device
     *            Das Gerät mit welchem der User angemolden ist
     */
    ...
    private void configureFrame() {
        ...
        guiManager
                ...
                .setHeight(1)
                .setComp(
                        new JLabel("Angemeldet mit: " + device.getDeviceName()));
        guiManager.setX(0).setY(1).setWeightY(1).setHeight(1).setWidth(9)
                .setComp(tabbedPane);
    ...
    private void createTabs() {
        for (MessageType type : device.getSupportedMessageFormats()) {
            if (!type.equals(MessageType.PRINT)) {
                MessagesTab mf = new MessagesTab(device,
                        device.getMessageClient(), type);
