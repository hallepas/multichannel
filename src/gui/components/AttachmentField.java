...
public class AttachmentField extends JPanel {
     ...
     * 
     * @param attachment
     *            die ausgewählte Datei (<code>Attachment</code>)
     * @param btDelete
     *            der Delete-Button. Beim klicken wird der Attachment gelöscht
     */
    ...
    private void configure() {
        ...
        guiManager.setX(0).setY(0).setWeightX(4).setWidth(4)
                .setFill(GridBagConstraints.HORIZONTAL).setComp(lbAttachement);
        guiManager.setX(4).setY(0).setWidth(1)
                .setFill(GridBagConstraints.HORIZONTAL).setComp(btDelete);
    }
