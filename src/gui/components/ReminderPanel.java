...
public class ReminderPanel extends JPanel {
    ...
    public void reminderUpdate(Date date) {
        if (date != null) {
            this.timeLb.setText("<html><b>Zeit:</b> "
                    + MessageProperties.TIME_FORMATTER.format(date) + "</html");
            this.dateLb.setText("<html><b>Datum:</b> "
                    + MessageProperties.DATE_FORMATTER.format(date) + "</html");
        } else {
